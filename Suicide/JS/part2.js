...
const RSgraph = async (height, width, margin) => {
  ...
  var comunas = states
    ...
    LineChart(elems["Russian Federation"], SCATTER_HEIGHT, SCATTER_WIDTH, SCATTER_MARGIN, fillScale);
    BarChart(elems["Russian Federation"].rango_etario, SCATTER_HEIGHT, SCATTER_WIDTH, SCATTER_MARGIN, fillScale);
}
...
.attr("font-size", 13)
.attr("font-family", "Arial, Helvetica, sans-serif")
.text("Number of suicides in 2013");   
